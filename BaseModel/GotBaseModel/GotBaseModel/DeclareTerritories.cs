...
namespace GotBaseModel
{
	class DeclareTerritories
	{
		public static List<Territory> MakeTerritories() 
		{
            ...
            Territory StonySept = new Territory("StonySept", null, TerritoryType.LandArea, false, false, 1, 0); AllTerritories.Add(StonySept);
            ...
            Territory SunspearHarbor = new Territory("SunspearHarbor", null, TerritoryType.HarborArea, false, false, 0, 1); AllTerritories.Add(SunspearHarbor);
