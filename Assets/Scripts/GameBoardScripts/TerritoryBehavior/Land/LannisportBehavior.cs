...
public class LannisportBehavior : GeneralTerritoryBehavior
{
    // Use this for initialization
    void Start()
    {
        Unit0Pos = new Vector3((float)5.25, (float)0.02, (float)4.4);
        Unit1Pos = new Vector3((float)5.39, (float)0.03, (float)4.84);
        Unit2Pos = new Vector3((float)5.39, (float)0.04, (float)5.22);
        Unit3Pos = new Vector3((float)5.07, (float)0.01, (float)5.67);

        OrderTokenPos = new Vector3((float)5.00, (float)0.06, (float)4.89);
