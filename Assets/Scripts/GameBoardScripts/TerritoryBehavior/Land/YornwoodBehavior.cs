...
public class YornwoodBehavior : GeneralTerritoryBehavior
{

    // Use this for initialization
    void Start()
    {
        Unit0Pos = new Vector3((float)2.55, (float)0.02, (float)12.31);
        Unit1Pos = new Vector3((float)2.23, (float)0.03, (float)12.31);
        Unit2Pos = new Vector3((float)1.92, (float)0.04, (float)12.31);
        Unit3Pos = new Vector3((float)1.63, (float)0.01, (float)12.31);

        OrderTokenPos = new Vector3((float)1.74, (float)0.06, (float)11.94);
