...
public class PykeBehavior : GeneralTerritoryBehavior
{
    // Use this for initialization
    void Start()
    {
        Unit0Pos = new Vector3((float)6.68, (float)0.02, (float)2.18);
        Unit1Pos = new Vector3((float)7.04, (float)0.03, (float)2.18);
        Unit2Pos = new Vector3((float)7.27, (float)0.04, (float)2.18);
        Unit3Pos = new Vector3((float)5.93, (float)0.01, (float)2.38);

        OrderTokenPos = new Vector3((float)6.59, (float)0.06, (float)2.81);
