...
public class IronThroneInfluenceTrackBehavior : InfluenceTrackBehaviorObserver {

	private InfluenceTrackSubject mySubject;

	private Vector3 Position1Pos = new Vector3((float)-4.74, (float)0, (float)-2.44);
	private Vector3 Position2Pos = new Vector3((float)-4.74, (float)0, (float)-3.67);
	private Vector3 Position3Pos = new Vector3((float)-4.74, (float)0, (float)-4.95);
	private Vector3 Position4Pos = new Vector3((float)-4.74, (float)0, (float)-6.19);
	private Vector3 Position5Pos = new Vector3((float)-4.74, (float)0, (float)-7.44);
	private Vector3 Position6Pos = new Vector3((float)-4.74, (float)0, (float)-8.69);
